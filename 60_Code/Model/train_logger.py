...
"""
    Informationen über den Ablauf des Trainings werden in eine
    JSON-Datei geloggt und können mit Hilfe des Notebooks "visualize_model_training.ipynb"
    im Ordner 80_Auswertungen angezeigt werden.
"""
