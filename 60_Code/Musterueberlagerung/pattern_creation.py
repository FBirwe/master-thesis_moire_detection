...
"""
    Stellt Funktionen zur Verfügung, mit denen zufällig, anhand von Konfigurationen,
    Eigenschaften für Pattern definiert werden und diese Pattern erzeugt werden können.
"""
