...
"""
    Erzeugt eine Anzahl an Jobs zur Erzeugung von synthetischen Moirés.
    Durch dieses Script wird festgelegt, welches Pattern mit welchen Parametern
    auf welche Objektkachel angwandt werden soll.
    Die Montage erfolgt durch das Script "musterueberlagerung.py".
"""
